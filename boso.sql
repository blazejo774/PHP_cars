...
--
-- Host: localhost
-- Generation Time: Jun 26, 2024 at 11:24 AM
...
CREATE TABLE `customers` (
  ...
  `salesRepEmployeeNumber` int(11) DEFAULT 1076,
...
(144, 'Volvo Model Replicas, Co', 'Berglund', 'Christina ', '0921-12 3555', 'BerguvsvĂ¤gen  8', NULL, 'LuleĂĄ', NULL, 'S-958 22', 'Sweden', 1504, 53100),
(145, 'Danish Wholesale Imports', 'Petersen', 'Jytte ', '31 12 3555', 'VinbĂŚltet 34', NULL, 'Kobenhavn', NULL, '1734', 'Denmark', 1401, 83400),
...
(169, 'Porto Imports Co.', 'de Castro', 'Isabel ', '(1) 356-5555', 'Estrada da saĂşde n. 58', NULL, 'Lisboa', NULL, '1756', 'Portugal', NULL, 0),
(171, 'Daedalus Designs Imports', 'RancĂ©', 'Martine ', '20.16.1555', '184, chaussĂ©e de Tournai', NULL, 'Lille', NULL, '59000', 'France', 1370, 82900),
...
(209, 'Mini Caravy', 'Citeaux', 'FrĂ©dĂ©rique ', '88.60.1555', '24, place KlĂ©ber', NULL, 'Strasbourg', NULL, '67000', 'France', 1370, 53800),
...
(216, 'Enaco Distributors', 'Saavedra', 'Eduardo ', '(93) 203 4555', 'Rambla de CataluĂąa, 23', NULL, 'Barcelona', NULL, '08022', 'Spain', 1702, 60300),
(219, 'Boards & Toys Co.', 'Young', 'Mary', '3105552373', '4097 Douglas Av.', NULL, 'Glendale', 'CA', '92561', 'USA', 1166, 11000),
(223, 'NatĂźrlich Autos', 'Kloss', 'Horst ', '0372-555188', 'TaucherstraĂźe 10', NULL, 'Cunewalde', NULL, '01307', 'Germany', NULL, 0),
(227, 'Heintze Collectables', 'Ibsen', 'Palle', '86 21 3555', 'Smagsloget 45', NULL, 'Ă…rhus', NULL, '8200', 'Denmark', 1401, 120800),
(233, 'QuĂ©bec Home Shopping Network', 'FresniĂ¨re', 'Jean ', '(514) 555-8054', '43 rue St. Laurent', NULL, 'MontrĂ©al', 'QuĂ©bec', 'H1J 1C3', 'Canada', 1286, 48700),
(237, 'ANG Resellers', 'Camino', 'Alejandra ', '(91) 745 6555', 'Gran VĂ­a, 1', NULL, 'Madrid', NULL, '28001', 'Spain', NULL, 0),
...
(256, 'Auto AssociĂ©s & Cie.', 'Tonini', 'Daniel ', '30.59.8555', '67, avenue de l\'Europe', NULL, 'Versailles', NULL, '78000', 'France', 1370, 77900),
(259, 'Toms SpezialitĂ¤ten, Ltd', 'Pfalzheim', 'Henriette ', '0221-5554327', 'Mehrheimerstr. 369', NULL, 'KĂśln', NULL, '50739', 'Germany', 1504, 120400),
...
(273, 'Franken Gifts, Co', 'Franken', 'Peter ', '089-0877555', 'Berliner Platz 43', NULL, 'MĂźnchen', NULL, '80805', 'Germany', NULL, 0),
...
(298, 'Vida Sport, Ltd', 'Holz', 'Mihael', '0897-034555', 'Grenzacherweg 237', NULL, 'GenĂ¨ve', NULL, '1203', 'Switzerland', 1702, 141300),
...
(335, 'Cramer SpezialitĂ¤ten, Ltd', 'Cramer', 'Philip ', '0555-09555', 'Maubelstr. 90', NULL, 'Brandenburg', NULL, '14776', 'Germany', NULL, 0),
...
(361, 'Kommission Auto', 'Josephs', 'Karin', '0251-555259', 'Luisenstr. 48', NULL, 'MĂźnster', NULL, '44087', 'Germany', NULL, 0),
...
(409, 'Stuttgart Collectable Exchange', 'MĂźller', 'Rita ', '0711-555361', 'Adenauerallee 900', NULL, 'Stuttgart', NULL, '70563', 'Germany', NULL, 0),
...
(448, 'Scandinavian Gift Ideas', 'Larsson', 'Martha', '0695-34 6555', 'Ă…kergatan 24', NULL, 'BrĂ¤cke', NULL, 'S-844 67', 'Sweden', 1504, 116400),
...
(458, 'Corrida Auto Replicas, Ltd', 'Sommer', 'MartĂ­n ', '(91) 555 22 82', 'C/ Araquil, 67', NULL, 'Madrid', NULL, '28023', 'Spain', 1702, 104600),
...
(477, 'Mit VergnĂźgen & Co.', 'Moos', 'Hanna ', '0621-08555', 'Forsterstr. 57', NULL, 'Mannheim', NULL, '68306', 'Germany', NULL, 0),
...
(484, 'Iberia Gift Imports, Corp.', 'Roel', 'JosĂ© Pedro ', '(95) 555 82 82', 'C/ Romero, 33', NULL, 'Sevilla', NULL, '41101', 'Spain', 1702, 65700),
...
CREATE TABLE `employees` (
  ...
  `reportsTo` int(11) DEFAULT 1002,
  `jobTitle` varchar(50) NOT NULL DEFAULT 'Sales Rep',
  `login` varchar(20) NOT NULL,
  `pass` varchar(20) NOT NULL,
  `role` varchar(20) DEFAULT 'stuff'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`, `login`, `pass`, `role`) VALUES
(1002, 'Murphy', 'Diane', 'x5800', 'd.murphy@classicmodelcars.com', '1', NULL, 'President', 'dmur', 'kernel21', 'root'),
(1056, 'Patterson', 'Mary', 'x4611', 'm.patterson@classicmodelcars.com', '1', 1002, 'VP Sales', 'mpat', 'kernel21', 'admin'),
(1076, 'Firrelli', 'Jeff', 'x9273', 'j.firrelli@classicmodelcars.com', '1', 1002, 'VP Marketing', 'jfir', 'kernel21', 'admin'),
(1088, 'Patterson', 'William', 'x4871', 'w.patterson@classicmodelcars.com', '6', 1056, 'Sales Manager (APAC)', 'wpat', 'kernel21', 'admin'),
(1102, 'Bondur', 'Gerard', 'x5408', 'g.bondur@classicmodelcars.com', '4', 1002, 'Sales Manager (APAC)', 'gbon', 'kernel21', 'admin'),
(1143, 'Bow', 'Anthony', 'x5428', 'a.bow@classicmodelcars.com', '1', 1056, 'Sales Manager (NA)', 'abow', 'kernel21', 'admin'),
(1165, 'Jennings', 'Leslie', 'x3291', 'l.jennings@classicmodelcars.com', '1', 1143, 'Sales Rep', 'ljen', 'kernel21', 'stuff'),
(1166, 'Thompson', 'Leslie', 'x4065', 'l.thompson@classicmodelcars.com', '1', 1143, 'Sales Rep', 'ltho', 'kernel21', 'stuff'),
(1188, 'Firrelli', 'Julie', 'x2173', 'j.firrelli@classicmodelcars.com', '2', 1143, 'Sales Rep', 'jfir', 'kernel21', 'stuff'),
(1216, 'Patterson', 'Steve', 'x4334', 's.patterson@classicmodelcars.com', '2', 1143, 'Sales Rep', 'spat', 'kernel21', 'stuff'),
(1286, 'Tseng', 'Foon Yue', 'x2248', 'f.tseng@classicmodelcars.com', '3', 1143, 'Sales Rep', 'ftse', 'kernel21', 'stuff'),
(1323, 'Vanauf', 'George', 'x4102', 'g.vanauf@classicmodelcars.com', '3', 1143, 'Sales Rep', 'gvan', 'kernel21', 'stuff'),
(1337, 'Bondur', 'Loui', 'x6493', 'l.bondur@classicmodelcars.com', '4', 1102, 'Sales Rep', 'lbon', 'kernel21', 'stuff'),
(1370, 'Hernandez', 'Gerard', 'x2028', 'g.hernandez@classicmodelcars.com', '4', 1102, 'Sales Rep', 'gher', 'kernel21', 'stuff'),
(1401, 'Castillo', 'Pamela', 'x2759', 'p.castillo@classicmodelcars.com', '4', 1102, 'Sales Rep', 'pcas', 'kernel21', 'stuff'),
(1501, 'Bott', 'Larry', 'x2311', 'l.bott@classicmodelcars.com', '7', 1102, 'Sales Rep', 'lbot', 'kernel21', 'stuff'),
(1504, 'Jones', 'Barry', 'x102', 'b.jones@classicmodelcars.com', '7', 1102, 'Sales Rep', 'bjon', 'kernel21', ''),
(1611, 'Fixter', 'Andy', 'x101', 'a.fixter@classicmodelcars.com', '6', 1088, 'Sales Rep', 'afix', 'kernel21', ''),
(1612, 'Marsh', 'Peter', 'x102', 'p.marsh@classicmodelcars.com', '6', 1088, 'Sales Rep', 'pmar', 'kernel21', ''),
(1619, 'King', 'Tom', 'x103', 't.king@classicmodelcars.com', '6', 1088, 'Sales Rep', 'tkin', 'kernel21', ''),
(1621, 'Nishi', 'Mami', 'x101', 'm.nishi@classicmodelcars.com', '5', 1056, 'Sales Rep', 'mnis', 'kernel21', ''),
(1625, 'Kato', 'Yoshimi', 'x102', 'y.kato@classicmodelcars.com', '5', 1621, 'Sales Rep', 'ykat', 'kernel21', ''),
(1702, 'Gerard', 'Martin', 'x2312', 'm.gerard@classicmodelcars.com', '4', 1102, 'Sales Rep', 'mger', 'kernel21', ''),
(1711, 'abc', 'abc', 'abc', 'audjdjsdjd@wp.pl', '1', 1002, 'Sales Rep', 'abc', 'abc', 'stuff'),
(1712, 'abc2', 'abc2', 'abc2', 'audjdjsdjd@wp.pl', '1', 1002, 'Sales Rep', 'abc2', 'abc2', 'stuff');
...
--
ALTER TABLE `employees`
  MODIFY `employeeNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1713;
COMMIT;
